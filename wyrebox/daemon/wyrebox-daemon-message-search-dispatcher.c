...
gboolean
wyrebox_daemon_message_search_dispatch (WyreboxDaemonMessageSearchService
    ...
    WyreboxDaemonResponseFrame *out_frame, GError **error)
{
  ...
  g_return_val_if_fail (WYREBOX_IS_DAEMON_MESSAGE_SEARCH_SERVICE (service),
      FALSE);
  ...
  if (wyrebox_daemon_message_search_service_handle_identity (service,
