 ...
 */
WyreboxLocalObjectStore *wyrebox_local_object_store_new (const char *root_dir,
    GError **error);
 ...
 */
gboolean wyrebox_local_object_store_put_bytes (WyreboxLocalObjectStore *self,
    GBytes *bytes,
    char **out_object_key,
    GError **error);
 ...
 */
GBytes *wyrebox_local_object_store_get_bytes (WyreboxLocalObjectStore *self,
