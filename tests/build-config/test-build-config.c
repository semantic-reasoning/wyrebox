...
#ifndef WYREBOX_HAVE_DOVECOT_BACKEND
#error "WYREBOX_HAVE_DOVECOT_BACKEND must be defined"
#endif
...
#ifndef WYREBOX_TEST_EXPECT_DOVECOT_BACKEND
#error "WYREBOX_TEST_EXPECT_DOVECOT_BACKEND must be defined"
#endif
...
#if WYREBOX_HAVE_DOVECOT_BACKEND != 0 && \
    WYREBOX_HAVE_DOVECOT_BACKEND != 1
#error "WYREBOX_HAVE_DOVECOT_BACKEND must be numeric 0 or 1"
#endif
...
main (void)
{
  if (WYREBOX_HAVE_CAPNP_SERIALIZATION !=
    ...
    return 1;
  if (WYREBOX_HAVE_DOVECOT_BACKEND != WYREBOX_TEST_EXPECT_DOVECOT_BACKEND)
    return 1;
